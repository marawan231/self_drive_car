...
const onBoardingTextColor = Color.fromARGB(255, 95, 105, 184);
const onBoardingBackgroundColor = Color(0xFF323D94);
const onBoardingTextButtonColor = Color(0xFF7379EE);
const loginIconsSuffixAndPrefixColor = Color.fromARGB(255, 44, 53, 100);
final labelColorInTextField =
    const Color.fromARGB(255, 4, 6, 17).withOpacity(.4);
const focusColorInTextField = Color.fromARGB(255, 114, 127, 201);
